...
MotorController::MotorController(int mot_dir, int mot_pwn, double kp, double ki, double *actual_speed_ptr, bool reverse) :
    pid(actual_speed_ptr, &cmd_speed, &tgt_speed, kp, ki, 0, DIRECT, AUTOMATIC), 
